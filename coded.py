#jangan di recode, udh cape nih buat program.
#recode gak jadi apa apa lo bangsat
#!/usr/bin/env python
#coding: utf-8
#EnCoDed
...
if sys.version_info[0] < 3:
	...
	print("\033[32m Por favor rode o En Or De com a versão superior ao python2.\033[1;m\n")
	exit(1)
...
os.system('xdg-open https://www.instagram.com/andrew.sianturi')
os.system('xdg-open https://andrew-exe.blogspot.com')
os.system('xdg-open https://youtube.com/channel/UCFdT1etN8h6A1BCocrjwzUQ')
os.system('xdg-open https://facebook.com/groups/hacksolustion')

janela = Tk()
Label(janela, font="Helvetica 13 bold", text="By : Mr.exe", width=180, height=2, bg="#161616", fg="green").pack()
janela.title("En Or De Coded")
...
def Md5():
	...
	resultado = open("complatecoded.txt", "w")
